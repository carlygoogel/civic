...
import civic_logo from "@/public/images/civic_logo.png";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-100 flex flex-col justify-between">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-center text-gray-600 max-w-2xl mb-8">
          Transforming constituent communication with cutting-edge AI
          technology. Streamline your workflow and enhance engagement.
        </p>
